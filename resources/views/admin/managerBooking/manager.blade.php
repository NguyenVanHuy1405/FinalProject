...
<div class="container">
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Manager Booking Room</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary">List booking room </h6>
        </div>
        <div class="card-body">
            @include('admin.managerBooking.list')
        </div>
    </div>
</div>
@endsection
